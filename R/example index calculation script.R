...
full.bri<-offshore_bri_calc_ed14(file_id="djg test",
...
uct.bri<-offshore_bri_calc_ed14(file_id="djg test - unchanged",
...
full.sqo<-alt.SQO_BLOE.generic(file_id = "djg test",
                               infauna_path = "example SQO data/example SQO data.csv",
                               output_path = "SQO dry run")

# this one runs the unchanged taxa example data

uct.sqo<-alt.SQO_BLOE.generic(file_id = "djg test - unchanged",
